...
def default(task, iterations, filename_prefix = 'Cars/'):
    policy_to_file(compute_policy(track_from_file(filename_prefix + 'task' + str(task) + '.txt'), iterations),
                   filename_prefix + 'policy_for_task' + str(task) + '.txt')
