from default_object_factories import get_adage_question_answerer
...
def main():
    question_answerer = get_adage_question_answerer()

    questions = load_questions('resources/adage_questions.txt')
